...
function fetchWebIdentityToken(config) {
    return __awaiter(this, void 0, void 0, function* () {
        const headers = new node_fetch_1.Headers({ Authorization: `bearer ${config.requestToken}` });
        const response = yield (0, node_fetch_1.default)(`${config.requestUrl}&audience=sigstore`, {
            headers,
        });
